...
export const seedAreas: Area[] = [
  ...
  { 
    ...
    minRestHours: 12,
    coverageRequirements: [
      { dayOfWeek: 1, startHour: 6, endHour: 22, minWorkers: 4, preferredWorkers: 5 },
      { dayOfWeek: 2, startHour: 6, endHour: 22, minWorkers: 4, preferredWorkers: 5 },
      { dayOfWeek: 3, startHour: 6, endHour: 22, minWorkers: 4, preferredWorkers: 5 },
      { dayOfWeek: 4, startHour: 6, endHour: 22, minWorkers: 4, preferredWorkers: 5 },
      { dayOfWeek: 5, startHour: 6, endHour: 22, minWorkers: 4, preferredWorkers: 5 },
      { dayOfWeek: 6, startHour: 6, endHour: 18, minWorkers: 3, preferredWorkers: 4 },
      { dayOfWeek: 0, startHour: 8, endHour: 18, minWorkers: 2, preferredWorkers: 3 },
    ],
    enableCoverageMode: false,
  },
  { 
